...
def main():
    ...
    for cname in client_dirs:
        ...
        client_train_loaders.append(get_loader(train_img, train_mask, CVCDataset, train_transform))
        client_val_loaders.append(get_loader(val_img, val_mask, CVCDataset, val_transform))
