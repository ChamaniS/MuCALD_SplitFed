...
def main():
    ...
    model = UNET(in_channels=3,out_channels=NUM_CLASSES).cuda()
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_iou_no_bg > best_iou:
            ...
            torch.save(model.state_dict(),'BestModels/best_model_centralized_Unet_Kvasir.pth')
            print("Model saved!")

    print("[INFO]: Testing the best model...")
    model.load_state_dict(torch.load('BestModels/best_model_centralized_Unet_Kvasir.pth'))
