...
if __name__ == "__main__":
    # === Hardcoded settings ===
    csv_path = "C:/Users/csj5/Projects/Causal-proxy/Proxy_variables_dir/fetus_No_location.csv"   # <-- change this to your CSV file
    hidden_units = 16
    batch_size = 512
    learning_rate = 1e-3
    l1_penalty = 1e-3
    ...
    # Save results
    np.save("Fetus_notears_mlp_raw.npy", A_final)
    cols = list(df.columns)
    print("\n=== Raw adjacency (A) saved to A_nofetus_mlp_raw.npy ===")
    ...
    A_df.to_csv("fetus_notears_mlp_raw.csv")
    print("\nAdjacency matrix fetus CSV saved to A_notears_mlp_raw.csv")
