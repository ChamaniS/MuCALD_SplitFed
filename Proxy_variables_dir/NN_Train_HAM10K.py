...
if __name__ == "__main__":
    # === Hardcoded settings ===
    csv_path = "C:/Users/csj5/Projects/Causal-proxy/Proxy_variables_dir/ham10k_No_location.csv"   # <-- change this to your CSV file
    hidden_units = 16
    batch_size = 512
    learning_rate = 1e-3
    l1_penalty = 1e-3
    ...
    # Save results
    np.save("A_notears_mlp_raw.npy", A_final)
    cols = list(df.columns)
    print("\n=== Raw adjacency (A) saved to A_notears_mlp_raw.npy ===")
    ...
    A_df.to_csv("A_notears_mlp_raw.csv")
    print("\nAdjacency matrix CSV saved to A_notears_mlp_raw.csv")
