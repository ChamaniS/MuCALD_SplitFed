...
class UNet_3Plus_SS(nn.Module):

    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        super(UNet_3Plus_SS, self).__init__()
    ...
    def forward(self, h2):
        ...
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(
            torch.cat(( h2_PT_hd4, h3_PT_hd4, h4_Cat_hd4, hd5_UT_hd4), 1))))  # hd4->40*40*UpChannels
        ...
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat((h2_PT_hd3, h3_Cat_hd3, hd4_UT_hd3, hd5_UT_hd3), 1))))  # hd3->80*80*UpChannels
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(
            torch.cat(( h2_Cat_hd2, hd3_UT_hd2, hd4_UT_hd2, hd5_UT_hd2), 1))))  # hd2->160*160*UpChannels

        return torch.sigmoid(hd2)
